...
class DataSourcesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create data_source" do
    assert_difference('DataSource.count') do
      post data_sources_url, params: { data_source: {  } }
    end

    assert_redirected_to data_source_path(DataSource.last)
  end
  ...
  test "should update data_source" do
    patch data_source_url(@data_source), params: { data_source: {  } }
    assert_redirected_to data_source_path(@data_source)
  end
